...
import static dao.generic.jdbc.ConnectionFactory.getConnection;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    //Não pode ser generico pois precisa de outras tabelas
    @Override
...
//		return venda;
        ...
        try {
            ...
            rs = stm.executeQuery();
            if (rs.next()) {
                Venda venda = VendaFactory.convert(rs); //setando os campos da venda
    ...
    private void buscarAssociacaoVendaProdutos(Connection connection, Venda venda)
        ...
        try {
            ...
            while(rsProd.next()) {
                //setando a quantidade de produtos e produtos da venda
    ...
    //fara o cadastor em duas tabelas - venda, produto_quantidade (não usado o metodo generico)
    @Override
